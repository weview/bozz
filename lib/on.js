...
Rpc.prototype.handleListener = function (msg) {
  ...
  return promise
  .then(res =>
    msg.properties.replyTo && this.ms.channel.sendToQueue(msg.properties.replyTo, new Buffer(stringifySafe({ err : null, res : res })), {
      correlationId : msg.properties.correlationId,
    })
  )
  .catch(e => {
    if (msg.properties.replyTo) {
      channel.sendToQueue(msg.properties.replyTo, new Buffer(stringifySafe({ err : error, res : null })), {
        correlationId : msg.properties.correlationId,
      });
    }
